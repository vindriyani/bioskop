			...
			<div class="get-intouch" id="contact">
				...
				<div class="get-intouch-grids">
					<div class="get-intouch-left-address">
						...
						<table width="284" border="1" cellpadding="8" cellspacing="0">
<form action="tiket.php" method="post">
  <tr>
    <th colspan="2"></tr>
  <tr>
    <td width="42">User ID </td>
    <td width="142"><input name="userid" type="text"/></td>
  </tr>
  <tr>
    <td>Password</td>
  ...
  <tr>
    <td colspan="2" align="center"><p>
      <a href="tiket.php"><input type="submit" name="submit" value="LOGIN"/ >
    </p>
      <p>&nbsp; </p></td>
  </tr>
  <tr>
    <td colspan="2" align="center">Belum Jadi Anggota? <a href="contact2.php">Daftar</a></td>
  </tr>
</form>
</table>
